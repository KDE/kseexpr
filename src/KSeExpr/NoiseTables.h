...
template <int d>
struct NOISE_TABLES {
    static const std::array<std::array<double, d>, 514> g;
};

template<> const std::array<std::array<double, 1>, 514>NOISE_TABLES<1>::g = 
                                    {{{-0.090145990972},
                                     {0.411026453868},
                                     {-0.132971130209},
                                     {0.0658028292851},
...
template<> const std::array<std::array<double, 2>, 514>NOISE_TABLES<2>::g
                                    {{{-0.151629, 0.988438},
                                     {-0.965502, 0.260395},
                                     {0.423502, 0.905895},
                                     {0.592141, 0.805834},
...
template<> const std::array<std::array<double, 3>, 514>NOISE_TABLES<3>::g =
...
template<> const std::array<std::array<double, 4>, 514>NOISE_TABLES<4>::g =
